    ...
    if (apexChart.length > 0) {
      ...
      if (analytics2.length > 0) {
        ...
        var chartBar = new ApexCharts(
          document.querySelector("#analytics2"),
          optionsBar
        );
        chartBar.render();
      }
      ...
      if (stockmarketdemo5.length > 0) {
        var options = {
          ...
          series: [
            {
              data: [
                25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54, 44, 12, 36, 9, 54,
                66, 41, 89, 63, 25, 25, 44, 12, 36, 9, 54, 44, 12, 36, 9,
              ],
            },
          ],
          ...
          series: [
            {
              name: "Male",
              data: generateDayWiseTimeSeries(
                new Date("11 Dec 2018 GMT").getTime(),
                20,
                {
                  min: 10,
                  max: 60,
      ...
      if (datingdemo4.length > 0) {
        ...
        var chartArea = new ApexCharts(
          document.querySelector("#datingdemo4"),
          optionsArea
        );
        chartArea.render();
      }
      ...
      if (realestatedemo3.length > 0) {
        ...
        var chartBar = new ApexCharts(
          document.querySelector("#realestatedemo3"),
          optionsBar
        );
        chartBar.render();
      }
      ...
      if (cryptodemo6.length > 0) {
        ...
        // data for the sparklines that appear below header area
        var sparklineData = [
          47, 45, 54, 38, 56, 45, 30, 31, 37, 39, 62, 30, 35, 41,
        ];
      ...
      if (cryptodemo7.length > 0) {
        ...
        var cryptodemo7 = new ApexCharts(
          document.querySelector("#cryptodemo7"),
          optionsDonutTop
        );
        cryptodemo7.render();
      }
      ...
      if (chartjsdemo1.length > 0) {
        ...
        var config = {
          ...
          options: {
            ...
            legend: {
              labels: {
                fontColor: color(window.chartColors.grey)
                  .alpha(0.8)
                  .rgbString(),
                fontFamily: "Roboto",
                fontSize: 12,
    ...
    if (sparkline.length > 0) {
      function Sparkline() {
        ...
        if (sparklinedemo3.length > 0) {
          $(sparklinedemo3).sparkline(
            [
              5, 8, 6, 7, 3, 5, 6, 8, 2, 8, 5, 10, 11, 10, 1, 6, 5, 7, 8, 10, 8,
              12, 7, 9, 5, 6, 10, 7, 8, 5, 6, 8, 5, 9, 3, 7, 1, 6, 4, 8, 4, 9,
              10, 13, 7, 8, 6, 4, 11, 5, 6, 4, 7, 10, 4, 7, 4, 9,
            ],
            {
              type: "bar",
              height: "200",
        ...
        if (sparklinedemo4.length > 0) {
          $(sparklinedemo4).sparkline(
            [5, 8, 6, 7, 3, 5, 6, 8, 4, 8, 5, 10, 11, 10, 5, 6, 5, 7, 8, 10],
            {
              type: "line",
              width: "100%",
              height: "200",
          ...
          $(sparklinedemo4).sparkline(
            [5, 8, 6, 7, 3, 5, 6, 8, 2, 8, 5, 10, 11, 10, 5, 6, 5, 7, 8, 10],
            {
              type: "bar",
              height: "200",
              barWidth: "10",
      ...
      $("#signupForm1").validate({
        ...
        errorPlacement: function (error, element) {
          ...
          if (!element.next("span")[0]) {
            $(
              "<span class='fa fa-times form-control-feedback pr-2'></span>"
            ).insertAfter(element);
          }
        },
